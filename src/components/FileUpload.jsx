...
export const FileUpload = ({name, returnSuccess}) => {
    ...
    const handleFileChange = async (e) => {
      try {
        ...
        const response = await fetch('https://expansion4-you-server.vercel.app/api/file/upload', {
            method: 'POST',
            body: formData,
        })
    ...
    return (
      <div>
        ...
        {fileData && <>
          ...
          loop="loop" 
          ></video>  
          : <img src={fileData} alt="Uploaded File" />}
        </>}
      </div>
    ) 
}
